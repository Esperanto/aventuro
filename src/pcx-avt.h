...
enum pcx_avt_action {
        ...
        PCX_AVT_ACTION_REPLACE_OBJECT_IN_ROOM = 0x01,
        PCX_AVT_ACTION_REPLACE_OBJECT_IN_ROOM_2 = 0x02,
        PCX_AVT_ACTION_REPLACE_MONSTER_IN_ROOM = 0x03,
        PCX_AVT_ACTION_REPLACE_MONSTER_IN_ROOM_2 = 0x04,
